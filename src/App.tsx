  ...
  return (
    <div className="min-h-screen">
      ...
      <LoopDetailSection
        ...
        body="Most of your market is not buying today. The ones who will buy soon are already sending signals: job changes, funding, hiring bursts, tech installs. The Connection Loop catches those signals and starts outreach before a competitor gets the first meeting. It runs on its own; your team does not have to poke it every morning."
        mechanics={[
      ...
      <LoopDetailSection
        ...
        body="You have happy customers who would expand, refer, and renew — if someone asked at the right time. But nobody has a system for knowing when that is. Era's Loyalty Loop tracks post-close signals — engagement patterns, satisfaction indicators, team growth — and turns them into expansion talks, referrals, and renewals when the signal says the timing is right. No cold upsell calls."
        mechanics={[
