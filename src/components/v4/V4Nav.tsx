// V4Nav.tsx — Main navigation for the /v4 route. Inline SVG ERA wordmark
// on the left (cropped from public/images/era-logo.svg, paths 2–4 only,
// the symbol is excluded), mono uppercase letter-spaced links in the
// middle, solid currentColor CTA on the right. Border-bottom of 1px
// currentColor.
//
// The wordmark uses fill="currentColor" so it inherits the section's
// text color. On the white statement section it renders as ink. On
// future colored sections (magenta, cobalt, ink) the same component
// will render in white without any additional code.
