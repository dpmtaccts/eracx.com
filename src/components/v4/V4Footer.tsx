 ...
 *
 * Ink-black-ground footer that gives the page weight at close.
 * Magazine-style colophon treatment: closing manifesto line,
 * full ERA logo lockup (symbol + wordmark, finally), three-column
 * body with section nav, contact, and publication info.
 *
 * Closing manifesto "Warmth is the work." bookends §01 Statement's
 * "Cold outbound is over." Reader who has scrolled the entire page
 * gets the visual rhyme.
 *
...
export function V4Footer() {
  return (
    <section className="v4-section v4-section--footer" id="colophon">
      <V4Header
        phase="§09 · COLOPHON"
        meta={['VOL ONE', 'ISSUE 04', 'ERACX.COM']}
      />

      <div className="v4-footer">
        <h2 className="v4-footer__manifesto">
          Warmth is the <em>work</em>.
        </h2>

        <svg
          className="v4-footer__logo"
        ...
        <div className="v4-footer__body">
          ...
          <div className="v4-footer__col">
            <div className="v4-footer__col-header">Contact</div>
            <a
              className="v4-footer__email"
              href="mailto:hello@eracx.com"
            >
              hello@eracx.com
            </a>
            <p className="v4-footer__contact-line">
              Direct email is the fastest path. No form, no funnel.
            </p>
          </div>

          <div className="v4-footer__col">
            <div className="v4-footer__col-header">Colophon</div>
            <p className="v4-footer__colophon-body">
