...
import { CircleDashed, Repeat, Signal, Target, TrendingUp, Users } from 'lucide-react'
import type { ComponentType, SVGProps } from 'react'
import { proofStrip, type ProofColumn } from '../content'

const ICONS: Record<ProofColumn['icon'], ComponentType<SVGProps<SVGSVGElement>>> = {
  TrendingUp,
  Users,
  Target,
  Repeat,
